...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public static void R_repaint(int tope, Vertice arboles) {//pinta lo q esta antes en el panel       
        ...
        for (int j = 0; j < tope; j++) {
            Pintar.pintarCirculo(jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), String.valueOf(arboles.getNombre(j)) + ";" + arboles.getNombreEquipo(j));
        }
        ...
        for (int j = 0; j < tope; j++) {// consultamos si se ha sado  click sobre algun nodo 
            if ((xxx + 2) > arboles.getCordeX(j) && xxx < (arboles.getCordeX(j) + 13) && (yyy + 2) > arboles.getCordeY(j) && yyy < (arboles.getCordeY(j) + 13)) {
                ...
                if (n == 0) {
                    ...
                    nombreLabel1.setText(arboles.getNombreEquipo(j));
                    id = j;
                    ...
                    nombreLabe2.setText(arboles.getNombreEquipo(j));
                    id2 = j;
                    n++;
                    Pintar.clickSobreNodo(jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), null, Color.orange);
                    if (id == id2) {// si id == id2 por q se volvio a dar click sobre el mismos nodo, se cancela el click anterio
                        n = 0;
                        Pintar.pintarCirculo(jPanel1.getGraphics(), arboles.getCordeX(id), arboles.getCordeY(id), String.valueOf(arboles.getNombre(id)) + ";" + arboles.getNombreEquipo(id));
                        id = -1;
                        id2 = -1;
                    }
                }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "RECORRIDO TOTAL", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(255, 255, 255)));
        ...
        if (evt.isMetaDown()) {
            ...
            if (!cicDerechoSobreNodo(coordenadaX, coordenadaY)) {// si  clik sobre  nodo es falso entra
                if (tope < 50) {
                    ...
                    nombre = JOptionPane.showInputDialog("Ingrese ciudad ");
                    ip = JOptionPane.showInputDialog("Ingrese las cordenadas");
                    this.setEnabled(true);

                    if (!(ip == null || nombre == null)) {
                        arboles.setIp(tope, ip);
                        arboles.setNombreEquipo(tope, nombre);
                        Pintar.pintarCirculo(jPanel1.getGraphics(), arboles.getCordeX(tope), arboles.getCordeY(tope), String.valueOf(arboles.getNombre(tope)) + ";" + arboles.getNombreEquipo(tope));
                        tope++;
                    } else {
            ...
            if (n == 2) {
                ...
                Pintar.pintarCirculo(jPanel1.getGraphics(), arboles.getCordeX(id), arboles.getCordeY(id), String.valueOf(arboles.getNombre(id)) + ";" + arboles.getNombreEquipo(id));
                Pintar.pintarCirculo(jPanel1.getGraphics(), arboles.getCordeX(id2), arboles.getCordeY(id2), String.valueOf(arboles.getNombre(id2)) + ";" + arboles.getNombreEquipo(id2));
                id = -1;
                id2 = -1;
            }
        }
