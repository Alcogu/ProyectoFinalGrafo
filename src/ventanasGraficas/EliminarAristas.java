...
/**
 *
 * @author David Escamilla Gutiérrez
 */
public class EliminarAristas extends javax.swing.JFrame {
    ...
    public void R_repaint() {
        ...
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(VentanaPrincipal.jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), String.valueOf(arboles.getNombre(j)) + ";" + arboles.getNombreEquipo(j));
    ...
    public EliminarAristas(Pintar pinta, Vertice arbole, int ii, Frame fram) {
        initComponents();
        i = ii;
        this.pintar = pinta;
        this.arboles = arbole;
