...
public class Algoritmo_Dijkstra {
    ...
    public Algoritmo_Dijkstra(Vertice arboles, int tope, int permanente, int nodoFin) {
    ...
    public void dijkstra() {
        ...
        if (permanente != verticeFin) {
            ...
            do {
                subAcomulado = 0;
                auxAumulado = 2000000000; // lo igualamos a esta cifra ya q el acomulado de los vertices, supuestamente  nunca sera mayor 
